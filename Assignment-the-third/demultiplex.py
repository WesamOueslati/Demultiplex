...
def demultiplex(R1: str, R2: str, R3: str, R4: str, barcodes: dict, output, cutoff) -> dict:
...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', '--index_1', help="index 1")
    parser.add_argument('-y', '--index_2', help="index 2")
